...
import { FaExclamationTriangle, FaCheckCircle, FaBook, FaCalendarAlt, FaCalculator, FaFileAlt, FaClock, FaFileInvoice, FaBalanceScale, FaMapMarkerAlt, FaCogs } from "react-icons/fa";
    ...
    const mistakes = [
        {
            ...
            avoid: "Use the CRA's RC4110: Employee or Self-Employed? guide. Never base classification solely on a contract; the actual working relationship determines status. When in doubt, treat as an employee or request a CRA ruling (CPT1 form)."
        },
        {
            ...
            avoid: "Know your remittance schedule (monthly, quarterly, accelerated) based on average monthly withholding amount. Automate reminders in payroll software. Remit on or before the due date, considering processing times."
        },
        {
            ...
            avoid: "Use current year's CRA payroll deduction tables or certified payroll software. Double-check calculations, especially for bonuses, retroactive pay, terminations. Know CPP exemptions (over 65, certain disability pensions) and EI insurable earnings caps."
        },
        {
            ...
            avoid: "Maintain digital records securely for 6+ years (per CRA requirement). Track: hours worked, pay rates, deductions, vacation accrual/use, leave, ROEs, contracts, classification rationale. Use a centralized HRIS/Payroll system."
        },
        {
            ...
            avoid: "Know provincial rules (eligibility, calculation methods - % vs. accrual). Pay correct holiday pay (avg daily wages) and premium pay for hours worked. Accrue vacation pay accurately and pay it out correctly on each pay or annually."
        },
        {
            ...
            avoid: "Reconcile payroll data quarterly. Validate all employee data (SIN, address) well before year-end. Use CRA-approved software for filing (T4 Web Forms, EFILE). File before the Feb 28 deadline. Proofread meticulously."
        },
        {
            ...
            avoid: "Issue ROEs electronically via ROE Web within 5 calendar days of an interruption of earnings (pay period end, last day paid). Train HR/Payroll staff thoroughly on ROE Web and code selection. Validate all details."
        },
        {
            ...
            avoid: "Know which legislation applies (federally regulated industries vs. provincial). Subscribe to updates from your provincial Ministry of Labour and federal Labour Program. Have provincial-specific payroll/HR checklists."
        },
        {
            icon: <FaMapMarkerAlt className="text-xl" />,
            ...
            avoid: "Determine the province of employment (usually where the employee physically reports to work). Update employee profiles immediately upon relocation. Ensure payroll software handles multi-provincial setups correctly."
        },
        {
            ...
            avoid: "Invest in certified payroll software (e.g., ADP, Ceridian, Wagepoint, QuickBooks Online Payroll) that automates calculations, remittances, filings, and stays updated. If complex (multiple provinces, contractors, equity comp), partner with a payroll provider or accountant specializing in Canadian payroll."
        }
    ];
    ...
    return (
        <div className="bg-white">
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            <tr className="hover:bg-gray-50">
                                <td className="py-4 px-6 font-medium">CRA Compliance Guarantee</td>
                                <td className="py-4 px-6 text-[#5a6a7a]">Avoid penalties with precise CPP, EI, tax deductions & remittances</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="py-4 px-6 font-medium">Provincial Expertise</td>
                                <td className="py-4 px-6 text-[#5a6a7a]">Accurate calculations for British Columbia, Alberta, & all provinces</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="py-4 px-6 font-medium">Direct Deposit Magic</td>
                                <td className="py-4 px-6 text-[#5a6a7a]">Employees paid on time, every time—with digital pay stubs</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="py-4 px-6 font-medium">Year-End Made Simple</td>
                                <td className="py-4 px-6 text-[#5a6a7a]">T4s, T4As, and ROEs prepared and filed correctly</td>
                            </tr>
                            <tr className="hover:bg-gray-50">
                                <td className="py-4 px-6 font-medium">Software Synced</td>
                                <td className="py-4 px-6 text-[#5a6a7a]">Integrates with QuickBooks, Xero, or your existing tools</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-[#0a2236]">Essential Processing</h3>
                            </div>
                            <ul className="space-y-2 text-[#5a6a7a]">
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                    <span>Salaried, hourly & contract worker pay runs (bi-weekly, semi-monthly, monthly)</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                    <span>Overtime, bonuses, vacation pay & expense reimbursements</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-[#0a2236]">Compliance & Reporting</h3>
                            </div>
                            <ul className="space-y-2 text-[#5a6a7a]">
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                ...
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                    <span>T4, T4A, and Record of Employment (ROE) preparation/filing</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div className="flex items-center mb-4">
                                <span className="text-2xl mr-3">👥</span>
                                <h3 className="text-xl font-semibold text-[#0a2236]">Employee Experience</h3>
                            </div>
                            <ul className="space-y-2 text-[#5a6a7a]">
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                    <span>Digital pay stubs & tax forms (secure online portal)</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div className="flex items-center mb-4">
                                <span className="text-2xl mr-3">🔧</span>
                                <h3 className="text-xl font-semibold text-[#0a2236]">Specialized Support</h3>
                            </div>
                            <ul className="space-y-2 text-[#5a6a7a]">
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
            ...
            <section className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                        <h3 className="text-xl font-semibold text-[#0a2236] mb-3">Small Businesses</h3>
                        <p className="text-[#5a6a7a] italic">"No more late nights calculating deductions!"</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                        <h3 className="text-xl font-semibold text-[#0a2236] mb-3">Startups</h3>
                        <p className="text-[#5a6a7a] italic">"Scale payroll seamlessly as you hire."</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                        <h3 className="text-xl font-semibold text-[#0a2236] mb-3">Restaurants/Retail</h3>
                        <p className="text-[#5a6a7a] italic">"Handle complex schedules, tips, and shift premiums."</p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                        <h3 className="text-xl font-semibold text-[#0a2236] mb-3">Remote Teams</h3>
                        <p className="text-[#5a6a7a] italic">"Pay Canada-wide employees accurately across provinces."</p>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 py-16">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex flex-wrap justify-center gap-6">
                        <div className="bg-gray-100 px-6 py-3 rounded-full">QuickBooks Certified</div>
                        <div className="bg-gray-100 px-6 py-3 rounded-full">CPB Canada Member</div>
                        <div className="bg-gray-100 px-6 py-3 rounded-full">100+ Canadian Clients</div>
                    </div>

                    <div className="text-center md:text-right">
                        <p className="text-2xl font-bold text-[#0a2236]">98% client retention rate</p>
                ...
                <div className="bg-white p-8 rounded-xl shadow-md mt-12 max-w-3xl mx-auto">
                    ...
                    <p className="font-semibold text-[#0a2236]">Navjot Singh, Kalgidhar Construction Ltd.</p>
                </div>
            </section>
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="space-y-8">
                    {mistakes.map((mistake, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-red-500">
                            <div className="p-6">
                                <div className="flex items-start gap-4 mb-4">
                                    <div className="bg-red-100 p-3 rounded-full text-red-600">
                                        {mistake.icon}
                                    </div>
                                    <h3 className="text-xl font-bold text-gray-800">{mistake.title}</h3>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="bg-red-50 p-4 rounded-lg">
                                        <h4 className="font-semibold text-red-700 mb-2">Potential Costs:</h4>
                                        <p className="text-gray-700">{mistake.cost}</p>
                                    </div>
                                    <div className="bg-green-50 p-4 rounded-lg">
                                        <h4 className="font-semibold text-green-700 mb-2">How to Avoid:</h4>
                ...
                <div className="mt-16 bg-blue-50 rounded-xl p-8">
                    ...
                    <div className="mt-8 p-6 bg-white rounded-lg border border-blue-200">
                        <p className="text-lg font-semibold text-gray-800">
                            <span className="text-blue-600"></span> Payroll errors are expensive and preventable. Investing in robust systems, expertise, and proactive compliance is far cheaper than CRA penalties, back payments, lawsuits, and damaged employee trust. Treat payroll as a critical risk management function, not just an administrative task.
                        </p>
                    </div>
                </div>
            </div>
