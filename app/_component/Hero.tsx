...
export default function Hero() {
    return (
        <>
            {/* Hero Section */}
            <section className="relative bg-[#0a3a4a] text-white min-h-[700px]">
                {/* Background Image */}
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 pt-16 pb-48 md:pb-32">
                    <div className="mb-4 text-[#4fd1f9] font-semibold tracking-widest text-lg">
                        WELCOME TO GAUDIT
                    </div>
            ...
            <div className="relative z-30 max-w-6xl mx-auto px-4 -mt-28 md:-mt-20">
                <div className="flex flex-col md:flex-row md:justify-end gap-6">
                    {/* Card 1 */}
                    <div className="w-full md:w-80 bg-[#008db3] text-white rounded-xl p-6 shadow-lg text-center">
                    ...
                    {/* Card 2 */}
                    <div className="w-full md:w-80 bg-[#00c6fb] text-white rounded-xl p-6 shadow-lg text-center">
            ...
            <section
                id="white-section"
                className="bg-white pt-40 md:pt-24 pb-24"
            >
