          ...
          {/* {openContact.importantDates &&
            openContact.importantDates.length > 0 && (
              <div className="flex items-start">
                ...
                <div>
                  <div
                    className="font-bold cursor-pointer hover:text-[#00c6fb] transition-colors"
                  ...
                  {openContact.importantDates.length > 3 && (
                    <div
                      className="text-sm text-white/60 cursor-pointer hover:text-[#00c6fb] transition-colors"
                      onClick={() => setIsModalOpen(true)}
                    >
