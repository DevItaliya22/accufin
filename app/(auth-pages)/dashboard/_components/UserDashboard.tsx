...
import { FileText, Upload, Bell, Download } from "lucide-react";
...
export default function UserDashboard() {
  const [activeTab, setActiveTab] = useState<
    "upload" | "responses" | "notifications"
  >("upload");
  ...
  const fetchData = async () => {
    try {
      const [uploadedFilesRes, responseFilesRes, notificationsRes] =
        await Promise.all([
      ...
      const [uploadedFilesData, responseFilesData, notificationsData] =
        await Promise.all([
